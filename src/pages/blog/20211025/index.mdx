...
| :---------------------------------------------------------- | :------------------- | :-------------- |
| <MaterialIcon class="text-text" iconName="folder" />     | Project Deliverables | Jane (XYZ Co)   |
| <MaterialIcon class="text-text" iconName="description"/> | Onboarding           | Margot (XYZ Co) |
| <MaterialIcon class="text-text" iconName="description"/> | Statement of Work    | Tina (XYZ Co)   |
| <MaterialIcon class="text-text" iconName="table_chart"/> | Team Contact Info    | Todd (ABC Inc)  |
| <MaterialIcon class="text-text" iconName="description"/> | Team Notes           | Zeke (ABC Inc)  |
...
| Type                                                         | Folder/ File Name       | Owner           |
| :----------------------------------------------------------- | :---------------------- | :-------------- |
| <MaterialIcon class="text-gray-50" iconName="folder" />      | Project Deliverables    | Jane (XYZ Co)   |
| <MaterialIcon class="text-gray-50" iconName="description" /> | DEL - Team Contact Info | Todd (ABC Inc)  |
| <MaterialIcon class="text-gray-50" iconName="description"/>  | DEL - Team Notes        | Zeke (ABC Inc)  |
| <MaterialIcon class="text-gray-50" iconName="description"/>  | Onboarding              | Margot (XYZ Co) |
| <MaterialIcon class="text-gray-50" iconName="description"/>  | Statement of Work       | Tina (XYZ Co)   |
| <MaterialIcon class="text-gray-50" iconName="table_chart" /> | Team Contact Info       | Jane (XYZ Co)   |
| <MaterialIcon class="text-gray-50" iconName="description"/>  | Team Notes              | Jane (XYZ Co)   |
