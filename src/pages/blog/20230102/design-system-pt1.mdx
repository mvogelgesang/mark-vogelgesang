...
description:
  "How does someone who is not a visual designer take on the task of creating a
  design system?"
hero:
...
design system documentation. I found Atlassian and IBM's documentation to be quite consumable and explained both the theory and practice of implementing a design system.
...
Following many of the principles of the 8pt grid, I adjusted font sizes and line heights of each major element. To do so, I leveraged Montserrat in various weights and sizes.

<img src="/posts/20230102/Light.png" width="49%" alt="mvogelgesang.com typography on a light background"></img>
<img src="/posts/20230102/Dark.png" width="49%" alt="mvogelgesang.com typography on a dark background"></img>
...
| Montserrat      | SemiBold 600 | h3               | 28             | 28               |
| Montserrat      | SemiBold 600 | h4               | 24             | 24               |
| Montserrat      | SemiBold 600 | h5               | 20             | 24               |
| Montserrat      | Regular 400  | p / prose        | 20             | 24               |
